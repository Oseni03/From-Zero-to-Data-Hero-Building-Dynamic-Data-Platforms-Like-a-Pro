...
DYNAMODB_TABLE_NAME = "dev.hudi_ingestion_framework"
...
def main():
    payload = {
        ...
        "created_by": "soumil",
        "cron_schedule": "0/15 * * * ? *",
        "jobName": "glue-sqs-ingestion-template-job",
        "lambda_arn": "arn:aws:lambda:us-east-1:XXX:function:XXXXX",
        "table_name": "customers",
        "s3_ingestion_config": {
            "s3_ingestion_path": "s3://XXX/",
            "table_name": "customers",
            "aws_account_id": "XXXX",
        ...
        "glue_payload": {
            ...
            "TARGET_S3_PATH": "s3://XXXXXX/silver/customers/",
            "INDEX_TYPE": "BLOOM",
